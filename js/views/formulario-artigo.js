/**
 * Tela de cadastro e edição de artigo — formulário completo.
 */
const ViewFormularioArtigo = {
    postId: null,
    slugManual: false,

    /** Monta o formulário vazio (novo) ou carrega dados (edição) */
    async renderizar(postId = null) {
        ...
        // Enquanto o usuário não mexer no slug, ele é gerado automaticamente pelo título
    ...
    /** Na edição, busca o post na API e preenche os campos */
    ...
    /** Envia os dados para criar ou atualizar o post */
