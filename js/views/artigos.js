/**
 * Tela de Artigos — lista em cards com busca, filtros e ações (ver, editar, excluir).
 */
const ViewArtigos = {
    categorias: [],

    /** Monta a página, filtros e carrega os posts */
    async renderizar() {
        ...
        area.innerHTML = `
            ...
            <div class="row g-4" id="lista-artigos">
                <div class="col-12 text-center py-5">
                    ...
                    <p class="text-muted mt-3 mb-0">Carregando artigos... A API pode levar até 1 minuto no plano Free.</p>
                </div>
            </div>
        `;
    ...
    /** Busca posts na API com os filtros que o usuário escolheu */
    async carregarPosts() {
    ...
    /** Liga os botões Ver, Editar e Excluir de cada card */
    ...
    /** Pede confirmação e apaga o artigo */
    async _excluir(id) {
